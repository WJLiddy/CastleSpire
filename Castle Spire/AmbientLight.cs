...
class AmbientLight
{
    public static readonly Color day = new Color(0f, 0f, 0f, 0f);
    public static readonly Color twilight = new Color(40f / 255f, 25f / 255f, 0f, 0.5f);
    public static readonly Color twilightNight = new Color(55f / 255f, 20f / 255f, 0f, 0.5f);
    public static readonly Color night = new Color(0f, 0f, 0f, 1f);
